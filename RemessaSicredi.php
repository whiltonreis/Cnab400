...
/* @ Não Alterar a partir deste ponto */
    ...
    private function NumeroDaRemessa(){
    	...
    	if($this->identificador == '9999999'){$this->identificador = 1;}
...
//0 - Nosso Numero
//1 - Data Vencimento 06 Caracteres
//2 - Valor do Titulo 13 Caracteres
//3 - Cpf ou Cnpj 14 Caracteres
//4 - Nome 40 Caracteres
//5 - Endereço 40 Caracteres
//6 - Cep 08 Caracteres
